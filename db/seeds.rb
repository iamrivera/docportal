...
anita.save
barry = Patient.new(first_name: "Barry", last_name: "Sanders", email: "barrys@anders.com", password: "GoSoxs!", occupation: "Athlete", marital_status: "Divorced", birthday: "1999-01-03", doctor: anita)
barry.save
larry = Patient.new(first_name: "Larry", last_name: "Bulls", email: "larryb@ulls.com", password: "GoBulls!", occupation: "Athlete", marital_status: "Divorced", birthday: "1999-04-03", doctor: anita)
larry.save
